    ...
    def forward(self, x, lens=None, infer=False):
        ...
        if lens is not None:
            ...
            for i in range(len(x)):
                ...
                # This followingstep is absolutely critical—please do not change it. 
                # Using an MLP for projection will severely degrade performance and ruin pretraining.
                ...
                # Trust me on this—don’t waste your time repeating these experiments. 
                # I only realized this after spending over 3000 GPU hours on an 8 NVIDIA H100 GPUs cluster. So sad.
